...
As a sample project, I use `goman`, the "missing man pages" tool for Go that turns the repo README into an ad-hoc help page. (See [this post]({{< ref "/post/goman/" >}}) for an intro to `goman`.)
...
[goman]({{< ref "/post/goman" >}}), the missing Go man pages viewer.
